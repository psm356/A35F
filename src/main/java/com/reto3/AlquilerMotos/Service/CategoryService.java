package com.reto3.AlquilerMotos.Service;

import com.reto3.AlquilerMotos.Repository.CategoryRepository;
import com.reto3.AlquilerMotos.modelo.Category;
        ...
        if(category.getId() != null){
            ...
            if(c.isPresent()){
                ...
                if(category.getMotorbikes() != null){
                    c.get().setMotorbikes(category.getMotorbikes());
                }
